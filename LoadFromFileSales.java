...
public class LoadFromFileSales {
                        ...
                        switch (typeOfProduct) {
                            case "HardDrive": {
                                ...
                                for (int i = 0; i < countToken; i++) {
                                    ...
                                    if (token2.equals("SALE_DATE")) SALE_DATE = st2.nextToken();
    ...
    public static void main(String[] args) {
        Shop shop = new Shop();
        load(shop, CreateFileSales.SALES_TXT);

        System.out.println(shop.displaySales());
    }// main
}